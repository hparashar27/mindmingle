...
const Footer = () => {
  return (
    <div><footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<div className="self-center text-2xl font-semibold">Mind Mingle</div>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracki uppercase dark:text-gray-50">Home</h3>
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">MoodTracer</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Therapy</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Discussions</a>
					</li>
					<li>
